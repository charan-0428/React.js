...
<footer class="footer">
  ...
  <section class="bg-light py-4 py-md-5 py-xl-8 border-top border-light mt-5 ">
    <div class="container overflow-hidden">
      <div class="row gy-4 gy-lg-0 justify-content-xl-between">
        <div class="col-12 col-md-4 col-lg-3 col-xl-2">
          <div class="widget">
            <a href="#!">
              <img src="./assets/th.jpeg" alt="Company Logo" width="175" height="57"/>
            </a>
          </div>
        </div>
        <div class="col-12 col-md-4 col-lg-3 col-xl-2">
          <div class="widget">
            ...
            <address class="mb-4">Hyderabad,Telangana,India</address>
            <p class="mb-1">
              <a class="link-secondary text-decoration-none" href="tel:+15057922430">(+91) xxxxx xxxxx</a>
            </p>
            <p class="mb-0">
      ...
      <div class="row gy-4 gy-md-0">
        <div class="col-xs-12 col-md-7 order-1 order-md-0">
          ...
          <div class="credits text-secondary text-center text-md-start mt-2 fs-7">
            Built by <a href="https://bootstrapbrain.com/" class="link-secondary text-decoration-none">Sidsai28</a> 
          </div>
        </div>
